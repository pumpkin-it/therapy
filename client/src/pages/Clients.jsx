              ...
              return (
                <tr key={c.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => navigate(`/clients/${c.id}`)}>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-gray-900"><span className="font-mono text-xs text-indigo-400 mr-1.5">CLI-{String(c.id).padStart(5,'0')}</span>{c.first_name} {c.last_name}</span>
