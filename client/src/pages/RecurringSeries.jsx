              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{s.practitioner_name} · {FREQ_LABEL[s.freq] || s.freq} on {DAY_NAMES[new Date(s.start_time).getDay()]}s starting {s.start_time?.slice(0,10)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
